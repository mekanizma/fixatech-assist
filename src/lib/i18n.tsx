...
const dict: Record<Lang, Dict> = {
  tr: {
    ...
    about: {
      ...
      story1: "2012 yılında küçük bir teknik servis atölyesi olarak yola çıkan PRAGMATECHNICAL, kısa sürede Kıbrıs'ın önde gelen otel ve restoran zincirlerinin tercih ettiği teknik servis ortağı haline geldi.",
  ...
  en: {
    ...
    about: {
      ...
      story1: "Founded in 2012 as a small technical workshop, PRAGMATECHNICAL quickly became the preferred service partner of leading hotel and restaurant chains in Cyprus.",
